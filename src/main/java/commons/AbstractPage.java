...
//waits
	...
	public String[] getListOfValueInTable(WebDriver driver, String rowXpath, String nextXpath,
			String currentStatusXpath, String attribute, String disableStatus) {
...
//	public String getTextInTittleOrDropdownValue(WebDriver driver, String... dynamicClassValue) {
//		waitForElementVisible(driver, MMS_DynanicUIs.DYNAMIC_TITLE_DROPDOWN_VALUE, dynamicClassValue);
//		return getTextElement(driver, MMS_DynanicUIs.DYNAMIC_TITLE_DROPDOWN_VALUE, dynamicClassValue).trim();
//	}
